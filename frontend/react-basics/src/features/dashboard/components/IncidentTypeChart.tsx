// File: src/features/dashboard/components/IncidentTypeChart.tsx
/**
 * What it does:
 * A "dumb" component that displays a 'Doughnut' chart.
 *
 * How it works:
 * - Receives 'chartData' as a prop.
 * - Uses 'react-chartjs-2' to render the chart.
 * - All logic is related to formatting data for the chart.
 *
 * How it connects:
