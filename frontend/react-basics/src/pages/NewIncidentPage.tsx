...
const FormSelect = ({ label, children, required = false }: FormSelectProps) => (
  <div>
    ...
    <select className="w-full p-3 h-12 form-input rounded-md ">
      {children}
    </select>
  </div>
);
        ...
        <div className="max-w-4xl mx-auto bg-[#2C3034] p-6 rounded-lg shadow-lg">
          ...
          <section className="mb-8">
            ...
            <div className="p-6 border-2 border-dashed border-[#495057] rounded-md text-center text-[#6C757D]">
              ...
              <p className="text-sm">
                or{" "}
                <span className="text-link-color font-semibold hover:underline">
                  browse files
                </span>
              </p>
            </div>
          ...
          <div className="flex justify-end gap-4 mt-8">
            <button className="btn-main-gray py-2 px-6 rounded-md">
              Cancel
            </button>
            <button className="btn-main-red py-2 px-6 rounded-md">
